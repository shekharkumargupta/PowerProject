...
@NamedQueries({
    ...
    @NamedQuery(name = "JobStatus.findAllByDepartmentId", query = "SELECT j FROM JobStatus j WHERE j.department.id = :departmentId"),
    @NamedQuery(name = "JobStatus.findAllByCompanyId", query = "SELECT j FROM JobStatus j WHERE j.department.company.id = :companyId"),
...
public class JobStatus implements Serializable {
    ...
    public String toString() {
        return "JobStatus{" + "id=" + id + ", name=" + name + ", department=" + department + '}';
    }
